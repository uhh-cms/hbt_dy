...
for i in [1,2,3]: #i steht für den channel
    ...
    plt.savefig(f"plots/hists_HH-outputnode/segmenting_in_pdgid_and_tau/linear_binning/stacked_tt/channel_id/{channelname[i-1]}-channel.png", dpi=300, bbox_inches='tight')
