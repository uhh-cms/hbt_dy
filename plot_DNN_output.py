...
for i in [1,2,3]: #i steht für den channel
    ...
    #relevant part for further subdivision:
...
#stacked hist weiter unterteilt in subprozesse (wie zuvor bei bar chart) (tt entfernt)
#to do: hists für category_ids statt channels machen (siehe mattermost)